...
//
//        BitMatrix bitMatrix = qrCodeWriter.encode(text, BarcodeFormat.QR_CODE, 600, 600, hints); // সাইজ ৩০০x৩০০ ই যথেষ্ট
//
...
//    }
    ...
    public String generateBase64QR(String text) throws Exception {
        ...
        // ৩০০x৩০০ সাইজ রাখুন
        BitMatrix bitMatrix = qrCodeWriter.encode(text, BarcodeFormat.QR_CODE, 600, 600, hints);
